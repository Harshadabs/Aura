...
const Honkai = () => {
  ...
  <h1 style={{ color: 'rgb(0, 0, 0)', textAlign: 'center' }}>
    LOGIN AND SERVER ID RECHARGE
        ...
        <div className="sidebar">
          ...
          <div class="instructions">
            <h3>How to Top Up the cheapest Honkai Star Rail Shards:</h3>
            <ol>
              ...
              <li>
                shards will automatically be recharged into the game account
              </li>
            </ol>
          </div>
        </div>
      ...
      <p class="instruction">
        Please enter your User ID & Server and make sure it is correct.
        Example: 123456789|server-asia.
      </p>
        <div class="input-row">
          <input type="number" placeholder="Input User ID" className="input-box" />
          <input
            type="number"
